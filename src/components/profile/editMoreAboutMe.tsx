        ...
        <ModalContent>
          <ModalHeader className="flex font-bold flex-col gap-1">
            ...
            <div className="flex items-center gap-2">
              ...
              {props.selectedItem==="height" && <p className="text-md">📏</p>}
              {props.selectedItem==="RealationStatus" && <p className="text-md">👩‍❤️‍👨</p>}
              {props.selectedItem==="languages" && <p className="text-md">🈶</p>}
              {props.selectedItem==="SexualityStatus" &&  <p className="text-md">🌈</p>}
              {props.selectedItem==="kids" && <p className="text-md">👦</p>}
              {props.selectedItem==="smoking" && <p className="text-md">🚬</p>}
              {props.selectedItem==="drink" && <p className="text-md">🥃</p>}
              {props.selectedItem==="pets" && <p className="text-md">🐶</p>}
