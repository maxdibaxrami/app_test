...
const ChatPage = () => {
  ...
  return (
    ...
    >
        ...
        <div className="mx-4">
          <Card shadow="none" isPressable as={Link} to={"/random-chat"} className="border-1 border-default-200 dark:border-default-100  backdrop-blur bg-neutral/20" radius="lg">
