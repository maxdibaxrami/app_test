    ...
    <Page back={false}>
      ...
      >
        ...
        {showFilter && (
          ...
          <div
            className="fixed w-full h-full z-50 left-1/2 transform -translate-x-1/2 bottom-0 "
          >

            <Navbar style={{ zIndex:1000 }} className="px-1 w-full flex items-start justify-center pb-4">
